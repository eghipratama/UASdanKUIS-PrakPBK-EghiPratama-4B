<template>
  <div class="location-widget">
    ...
    <button @click="fetchLocationDetails" class="custom-button">Find Location Details</button>
...
.custom-button {
  ...
  border-radius: 20px;
  font-size: 16px;
  background-image: linear-gradient(to right, #4b514f, #4b514f);
  color: #fff;
  cursor: pointer;
...
.custom-button:hover {
  background-image: linear-gradient(to right, #222320, #222320);
}
